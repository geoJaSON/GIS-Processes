...
print('*******************************************************************\n')
while True:
    portal = input("Enter number for portal: 1- Corpsnet, 2- AGOL, 3 - Partners: ")
    if portal == "1" or portal == "2" or portal == "3":
        #do some
        break 
    else:
...
while True:
    gidf = input("Global ID field format: 1 -'globalid', 2- 'GLOBALID', 3- 'GlobalID': ")
